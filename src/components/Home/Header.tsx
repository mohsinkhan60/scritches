...
const Header: React.FC = () => {
  return (
    <header className="relative  bg-[#FBF7F4] rounded-[46px] max-width-full my-2 mx-[72px] overflow-hidden">
      {/* Background accents */}
      ...
      <div className="max-w-[540px] mx-auto px-6 py-24 md:py-10 text-center relative">
        ...
        {/* Title */}
        <h1 className="font-urbanist font-extrabold text-4xl sm:text-5xl md:text-[60px] text-[#333333] leading-[1.27]">
        ...
        {/* Decorative line */}
        <img
          src="https://framerusercontent.com/images/u0hKN8eM9X9Mjqp03kGSZHa13y0.svg"
        ...
        <p className="text-[#5a6b7b] text-base sm:text-lg md:text-xl font-medium max-w-2xl mx-auto">
          Scritches is your partner in transforming your solo pet sitting or dog
          walking business from <strong>side hustle</strong> to{" "}
        ...
        <div className="mt-12 flex flex-col items-center gap-3">
          <p className="text-[#5a6b7b] text-sm md:text-base font-medium">
            Join <strong>300+ petpreneurs</strong> already growing their
            business
          </p>
          ...
          <a
            ...
            className="px-8 py-3 rounded-full text-white text-lg font-medium font-urbanist bg-[#53a57d] hover:bg-[#44986f] transition-all shadow-md hover:shadow-lg"
          >
            Start for free
          </a>
        </div>
      ...
      <img
        ...
        className="absolute bottom-0 left-4 w-28 md:w-36"
      />
      <img
